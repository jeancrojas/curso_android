package es.cice.vehiculostoolbartest.adapters;
...
import es.cice.vehiculostoolbartest.CarDetailActivity;
import es.cice.vehiculostoolbartest.R;
...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.ViewHolder> implements Filterable{
    ...
    public class CarFilter extends Filter {
        static final String TAG = "CarAdapter";
        ...
        protected FilterResults performFiltering(CharSequence filterData) {
            ...
            FilterResults resulsts = new FilterResults();
